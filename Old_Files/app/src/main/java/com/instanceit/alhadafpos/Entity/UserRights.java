...
public class UserRights {
    ...
    @Expose
    private ArrayList<NavChild> child = null;

    public UserRights(String pagename, String appmenuname, Integer isindividual, Integer viewright) {
    ...
    public ArrayList<NavChild> getChild() {
        return child;
    }

    public void setChild(ArrayList<NavChild> child) {
        this.child = child;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        UserRights userright = (UserRights) obj;
        if (this.appmenuname.equals(userright.getAppmenuname())) {
            return true;
        } else {
            return false;
        }
