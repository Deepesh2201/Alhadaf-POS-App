...
public class BillIMemberShipAdapter extends RecyclerView.Adapter<BillIMemberShipAdapter.ViewHolder> {

    Context context;
    ArrayList<MembershipCourseItem> cartArrayList;

    public BillIMemberShipAdapter(Context context, ArrayList<MembershipCourseItem> cartArrayList) {
...
//        holder.tv_prt_Qty.setText("1");
        ...
        holder.tv_prt_price.setText(String.format("%.2f", cartArrayList.get(position).getTaxable()));
        holder.tv_prt_total_Amt.setText(String.valueOf(cartArrayList.get(position).getFinalprice()));
        holder.tv_prt_Qty.setText(String.format("%.2f", cartArrayList.get(position).getIgsttaxamt()));
