...
public class ServiceOrderDetail {
    ...
    @Expose
    private String isserviceorderdetail;
    @SerializedName("serviceorderdetailinfo")
    @Expose
    private ArrayList<Storeorderdetailinfo> serviceorderdetailinfo = null;
    @SerializedName("isserviceorderpaymentdetail")
    @Expose
    private String isserviceorderpaymentdetail;
    @SerializedName("referenceno")
    @Expose
    private String referenceno;
    @SerializedName("serviceorderpaymentdetailinfo")
    @Expose
    private ArrayList<Storeorderpaymentdetailinfo> serviceorderpaymentdetailinfo = null;
    ...
    public String getIsserviceorderdetail() {
        return isserviceorderdetail;
    }

    public void setIsserviceorderdetail(String isserviceorderdetail) {
        this.isserviceorderdetail = isserviceorderdetail;
    }

    public ArrayList<Storeorderdetailinfo> getServiceorderdetailinfo() {
        return serviceorderdetailinfo;
    }

    public void setServiceorderdetailinfo(ArrayList<Storeorderdetailinfo> serviceorderdetailinfo) {
        this.serviceorderdetailinfo = serviceorderdetailinfo;
    }

    public String getIsserviceorderpaymentdetail() {
        return isserviceorderpaymentdetail;
    }

    public void setIsserviceorderpaymentdetail(String isserviceorderpaymentdetail) {
        this.isserviceorderpaymentdetail = isserviceorderpaymentdetail;
    }

    public ArrayList<Storeorderpaymentdetailinfo> getServiceorderpaymentdetailinfo() {
        return serviceorderpaymentdetailinfo;
    }

    public void setServiceorderpaymentdetailinfo(ArrayList<Storeorderpaymentdetailinfo> serviceorderpaymentdetailinfo) {
