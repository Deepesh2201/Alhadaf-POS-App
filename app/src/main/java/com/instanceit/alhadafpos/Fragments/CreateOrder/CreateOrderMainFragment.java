package com.instanceit.alhadafpos.Fragments.CreateOrder;

import static android.view.View.GONE;
import static android.view.View.VISIBLE;

import static com.instanceit.alhadafpos.Utility.Utility.initExitMessagePopupWindow;
...
public class CreateOrderMainFragment extends Fragment {
    ...
    //    Views
    public RecyclerView rv_cart, rv_membership_list, rv_item_list, rv_lastvisit, rv_operation_flow_list;
    ...
    public TextView tv_total_price, tv_lbl_nodata_customer, tv_tot_disc_amount, tv_total_taxable_amt, tv_tot_vat, tv_total_payable_amount, tv_lbl_title_customer_det, tv_passport_id, tv_passport_expiry;
    ...
    RelativeLayout rl_mycart, rl_no_item, rl_item_main;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_create_order_main, container, false);
    }
...
//        swiperefresh = view.findViewById(R.id.swiperefresh);
    ...
    private void Initialization(View view) {
        tv_goto_service_order.setVisibility(VISIBLE);
...
//        callApiItemList();
        ...
        tv_cart_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                rl_mycart.setVisibility(View.VISIBLE);
        ...
        tv_customerdata_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                view_customer360.setVisibility(View.VISIBLE);
...
//        });
        ...
        mainActivity.iv_range_booking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                OpenRangeBookingDialog();
            }
        });

        tv_goto_service_order.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putString(AppConstant.ACTION, AppConstant.ACTION_LISTING_RIGHTS);
                bundle.putString(AppConstant.LAST_ADDED_CUST_CONTACT, SessionManagement.getStringValue(getContext(), AppConstant.LAST_ADDED_CUST_CONTACT, ""));
                        ...
                        try {
                            ...
                            if (status == 1) {
                                ...
                                if (jsonObject.has("itemdata")) {
                                    ...
                                    itemListAdapter = new ItemListAdapter(getContext(), itemsArrayList, CreateOrderMainFragment.this, null);
                            ...
                            if (status == 1) {
                                ...
                                if (jsonObject.getInt("ismemberdata") == 1) {
                                    ...
                                    if (member360ArrayList.get(0).getIsmshipdetail() == (1)) {
                                        ...
                                        tv_active_pck_title.setVisibility(View.VISIBLE);
...
//                            Log.e("TAG", "callApiGetWrokFlow: " + response);
                            ...
                            int isserviceorder = jsonObject.getInt("isserviceorder");
                ...
                for (int j = 0; j < cartArrayList.get(i).getSummaryDetails().size(); j++) {
                    if (cartArrayList.get(i).getSummaryDetails().get(j).getType() != null && cartArrayList.get(i).getSummaryDetails().get(j).getType().equals("2")) {
                        ...
                        if (cartArrayList.get(i).getSummaryDetails().get(j).getTaxtype().equals("1")) {
                            //  Exclusive  tax
                            taxableamt = (cartArrayList.get(i).getSummaryDetails().get(j).getFinalprice());
                            ...
                            // Inclusive  tax
                            final_Price = (cartArrayList.get(i).getSummaryDetails().get(j).getFinalprice());
                        ...
                        total_taxable_amount_withqty += taxableamt;
                        total_tax_amount_withqty += taxamt;
                        total_payable_amount_withqty += cartArrayList.get(i).getSummaryDetails().get(j).getFinalprice();
                    } else {
                        total_price_withqty += cartArrayList.get(i).getSummaryDetails().get(j).getQty()
                                * (cartArrayList.get(i).getSummaryDetails().get(j).getPrice());
    ...
    public void SetCartAdapter() {
        ...
        try {
            if (cartArrayList != null && cartArrayList.size() > 0) {
                ...
                /*CartAdapter*/
//                cartAdapter = new CartAdapter(getActivity(), cartArrayList, null, -1, null);
//                rv_cart.setAdapter(cartAdapter);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status == 1) {
                                ...
                                CashNoteAdapter cashNoteAdapter = new CashNoteAdapter(getContext(), currencyModelArrayList, et_amount, CreateOrderMainFragment.this, null);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("status") == 1) {
                                ...
                                PaymentTypeAdapter paymentTypeAdapter = new PaymentTypeAdapter(getContext(), paymentmodelArrayList, CreateOrderMainFragment.this, null);
    ...
    public void Additemtopaymentlist() {
        ...
        if (!et_amount.getText().toString().isEmpty() && Double.valueOf(et_amount.getText().toString()) > 0 && !et_amount.getText().toString().equals("")) {
            ...
            PaymentAdapter paymentAdapter = new PaymentAdapter(getContext(), paymentModelArrayList, CreateOrderMainFragment.this, null);
...
//                                    callApiItemList();
    ...
    public void onResume() {
        ...
        mainActivity.iv_search.setVisibility(GONE);
        mainActivity.iv_menu.setVisibility(View.VISIBLE);
        mainActivity.iv_add_contact.setVisibility(View.VISIBLE);
        mainActivity.iv_workflow.setVisibility(GONE);
        mainActivity.iv_range_booking.setVisibility(GONE);
        mainActivity.navParentItem(AppConstant.TXT_APPMENU_STORE_ORDER);
    }
...
//                        callApiItemList();
                        ...
                        initExitMessagePopupWindow(getActivity(), "Do you want to exit application?");
                    }
                    return true;
                }
                return false;
